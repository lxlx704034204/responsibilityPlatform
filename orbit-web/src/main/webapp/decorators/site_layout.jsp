...
<title><decorator:title default="欢迎"></decorator:title></title>
			...
			<div role="tabpanel" class="tab-pane fade active in" id="today" aria-labelledby="today-tab">
				<dl>
					...
					<ul class="nav nav-sidebar">
					    ...
					    <li><a href="#">二代平台报警分析<span class="badge">120/200</span></a></li>
					    <li><a href="<s:url namespace="/regular/cekongevents" action="index"></s:url>">测控事件<span class="badge">120/200</span></a></li>
					    <li><a href="#">备忘录<span class="badge">120/200</span></a></li>
					    <li><a href="<s:url namespace="/regular/yaoceparams" action="index"></s:url>">重点遥测参数趋势图<span class="badge">120/200</span></a></li>
					  </ul>
					</dd>
					<dt>在轨管理工作</dt>
					<dd>
						<ul class="nav nav-sidebar">
						    <li><a href="">型号1<span class="badge">120/200</span></a></li>
						    <li><a href="">型号2<span class="badge">120/200</span></a></li>
						    <li><a href="">型号3<span class="badge">120/200</span></a></li>
						  </ul>
					</dd>
					<dt>
						工作成果
					...
					<dd>
						<ul class="nav nav-sidebar">
				    <li><a href="">报警分析软件</a></li>
				    <li><a href="">测控事件记录软件</a></li>
				    <li><a href="">遥测数据监视软件</a></li>
					<li><a href="">型号联系人电话表</a></li>
				  </ul>
					</dd>
				</dl>
